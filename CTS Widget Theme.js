...
// CTS Widget Theme.js
// Source unique des couleurs et surfaces du widget CTS.

const GRADIENT_LOCATIONS = Object.freeze([
  0,
  0.32,
  0.68,
  1
...
const PALETTES = Object.freeze({
  NEXT: Object.freeze({
    gradient: ["#294366", "#1A2E4A", "#101D31", "#080E18"],
    accent: "#A9C9F4"
  }),
  ...
  WORK: Object.freeze({
    gradient: ["#225044", "#17392F", "#0D251F", "#06130F"],
    accent: "#9DDBBC"
  }),
  PAUSE: Object.freeze({
    gradient: ["#4B371F", "#342615", "#21170C", "#100A05"],
    accent: "#EFC889"
  }),
  CUT: Object.freeze({
    gradient: ["#3B2B56", "#291D40", "#190F2A", "#0C0714"],
    accent: "#D8B9F7"
  }),
  DONE: Object.freeze({
    gradient: ["#373A42", "#272A31", "#181A1F", "#0B0C0F"],
    accent: "#D0D4DA"
  }),
  UNKNOWN: Object.freeze({
    gradient: ["#29313D", "#1B222C", "#11171E", "#080B0F"],
    accent: "#B6C0CD"
  })
})
...
function createBaseWidget(stateType) {
  ...
  widget.backgroundGradient = createGradient(
...
function getGradientColors(stateType) {
  return [...getPalette(stateType).gradient]
}
...
function getAccentColor(stateType) {
  return new Color(getAccentHex(stateType))
}

function getSecondaryColor() {
  return new Color(COLORS.secondaryText)
}

function getPrimaryTextColor() {
  return new Color(COLORS.primaryText)
}

function getInactiveTextColor() {
  return new Color(COLORS.inactiveText)
}

function getInactiveTimeColor() {
  return new Color(COLORS.inactiveTime)
}

function getErrorBackgroundColor() {
  return new Color(COLORS.errorBackground)
}
