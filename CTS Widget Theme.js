...
const PALETTES = Object.freeze({
  NEXT: Object.freeze({
    gradient: ["#122435", "#0C1A2C", "#07111D", "#03080F"],
    accent: "#98CCFF"
  }),
  ...
  WORK: Object.freeze({
    gradient: ["#0B2620", "#081D18", "#051310", "#020908"],
    accent: "#6FE0AF"
  }),
  PAUSE: Object.freeze({
    gradient: ["#2B1D0F", "#20160B", "#150E07", "#090603"],
    accent: "#FFC96B"
  }),
  CUT: Object.freeze({
    gradient: ["#251937", "#1B1229", "#110B1B", "#08050D"],
    accent: "#D6B2FF"
  }),
  DONE: Object.freeze({
    gradient: ["#1F2126", "#17191D", "#0F1013", "#070809"],
    accent: "#D6DBE2"
  }),
  UNKNOWN: Object.freeze({
    gradient: ["#1A1F27", "#13171D", "#0C0F13", "#05070A"],
    accent: "#B9C4D2"
  })
})
...
function normalizeStateType(value) {
  const normalized = String(value || "")
    .trim()
    .toUpperCase()
  return Object.prototype.hasOwnProperty.call(PALETTES, normalized) ? normalized : "UNKNOWN"
}
...
function translucentWhite(opacity) {
  return new Color("#FFFFFF", clampOpacity(opacity))
}
