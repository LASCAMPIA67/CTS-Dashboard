...
function normalizeFamily(value) {
  ...
  return VALID_FAMILIES.includes(
    family
  )
    ? family
    : "large"
...
function validateContext(context) {
  if (
    ...
    return {
      valid: false,
      error:
        "Le contexte du widget est absent."
    }
  }
