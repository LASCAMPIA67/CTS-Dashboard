...
// CTS Utils.js
// Fonctions utilitaires communes au projet CTS Dashboard.
...
function getShortcutInput() {
  ...
  if (
    ...
    if (Array.isArray(parameter.texts)) {
      return parameter.texts.join("\n")
    }
  }
